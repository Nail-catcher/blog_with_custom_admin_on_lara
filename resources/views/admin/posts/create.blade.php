...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Добавить пост
        <small>Для добавления новости, отчета или элеманта портфолио, выберите соответствующую категорию</small>
      </h1>
    </section>
        ...
        <div class="box-body">
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <p class="help-block">Рекомендуемое соотношение сторон картинки 16:9</p>
            </div>
            <div class="form-group">
